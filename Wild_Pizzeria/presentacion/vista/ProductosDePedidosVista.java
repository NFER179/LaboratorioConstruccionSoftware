...
public class ProductosDePedidosVista extends JDialog {
	...
	public ProductosDePedidosVista(JDialog Dialog){
		...
		this.modelSabores = new DefaultTableModel(null, this.nombreColunmnas);
		this.table = new JTable(this.modelSabores);
