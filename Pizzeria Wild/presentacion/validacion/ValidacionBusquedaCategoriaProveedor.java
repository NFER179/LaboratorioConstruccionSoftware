...
public class ValidacionBusquedaCategoriaProveedor {
	...
	public ValidacionBusquedaCategoriaProveedor(ControladorBusquedaCategoriasProveedor Ctr, BusquedaCategoriasProveedorVista Vista) {
	...
	public boolean AsignarValido() {
		...
		if(CategoriaModelo.HayRepetidas(this.ctrBusqueda.CategoriasYaAsigandas(), this.ctrBusqueda.CategoriasSeleccionadas())) {
