...
public class ControladorCliente implements ActionListener {
	...
	private void CargarTabla() {
		...
		this.vtCliente.getModelTable().setColumnIdentifiers(this.vtCliente.getNombreColumna());
		for(ClienteDTO c:this.mdlCliente.ObtenerClientes()) {
			Object[] fila = {c.getClienteId(), c.getApellido() + " " + c.getNombre()};
	...
	private void Crear() {
		ControladorABMCliente ctr = new ControladorABMCliente(this, this.vtCliente);
