...
public class ABMProveedorVista extends JDialog {
	...
	public ABMProveedorVista(ProveedorVista Vista) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				ABMProveedorVista.class.getResource("/Iconos/pizza_1.PNG")));

		setResizable(false);
		setTitle(" Proveedor");
		setBounds(100, 145, 550, 337);
		...
		this.modelCategoria = new WDefaultTableModel(null,
				this.nombreColumnasCategoria);
		...
		btnGuardar.setIcon(new ImageIcon(ABMProveedorVista.class
				.getResource("/Iconos/Guardar.png")));
		btnGuardar.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnGuardar.setBounds(236, 242, 140, 40);
		getContentPane().add(btnGuardar);

		btnCancelar = new JButton(" Cancelar");
		btnCancelar.setIcon(new ImageIcon(ABMProveedorVista.class
				.getResource("/Iconos/salir.png")));
		btnCancelar.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnCancelar.setBounds(386, 242, 140, 40);
		...
		lblNewLabel.setIcon(new ImageIcon(ABMProveedorVista.class
