...
public class ABMRepartidorVista extends JDialog {
	...
	public ABMRepartidorVista(RepartidorVista Vista) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				ABMRepartidorVista.class.getResource("/Iconos/pizza_1.PNG")));
		...
		btnGuardar.setIcon(new ImageIcon(ABMRepartidorVista.class
		...
		btnCancelar.setIcon(new ImageIcon(ABMRepartidorVista.class
