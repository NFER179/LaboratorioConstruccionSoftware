...
public class VentasVista extends JFrame {
	...
	public VentasVista() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				VentasVista.class.getResource("/Iconos/pizza_1.PNG")));
		try {
	...
	private void initialize() {
		...
		lblNewLabel.setIcon(new ImageIcon(VentasVista.class
				.getResource("/Iconos/catering_pizzetas_y_empanadas.png")));
