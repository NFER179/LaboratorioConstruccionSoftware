...
public class ProductosDeVentasVista extends JDialog {
	...
	public ProductosDeVentasVista(JDialog Dialog) {
		...
		btnBusqueda.setIcon(new ImageIcon(ProductosDeVentasVista.class
		...
		btnAceptar.setIcon(new ImageIcon(ProductosDeVentasVista.class
		...
		btnCancelar.setIcon(new ImageIcon(ProductosDeVentasVista.class
		...
		lblNewLabel.setIcon(new ImageIcon(ProductosDeVentasVista.class
				.getResource("/Iconos/Logo Pizzeria Wild 2.png")));
