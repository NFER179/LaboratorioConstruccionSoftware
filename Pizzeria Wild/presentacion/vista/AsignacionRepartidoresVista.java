...
public class AsignacionRepartidoresVista extends JDialog {
	...
	private String[] NombreColumnas = { "Fecha Pedido", "Pedido", "Direccion",
			"Observacion Delivery" };
	...
	public AsignacionRepartidoresVista(JFrame Frame) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				AsignacionRepartidoresVista.class
		...
		btnBuscarrepartidor.setIcon(new ImageIcon(
				AsignacionRepartidoresVista.class
		...
		btnAsignar.setIcon(new ImageIcon(AsignacionRepartidoresVista.class
				.getResource("/Iconos/OK.png")));
		this.btnAsignar.setBounds(192, 382, 140, 40);
		this.contentPanel.add(this.btnAsignar);

		this.btnCancelar = new JButton("Cancelar");
		btnCancelar.setIcon(new ImageIcon(AsignacionRepartidoresVista.class
