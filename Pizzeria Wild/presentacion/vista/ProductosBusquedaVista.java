...
public class ProductosBusquedaVista extends JDialog {
	...
	public ProductosBusquedaVista(JDialog Dialog) {
		...
		btnAceptar.setIcon(new ImageIcon(ProductosBusquedaVista.class
		...
		btnCancelar.setIcon(new ImageIcon(ProductosBusquedaVista.class
