...
public class ComboVista extends JFrame {
	...
	public ComboVista() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				ComboVista.class.getResource("/Iconos/pizza_1.PNG")));
		setTitle(" Combo");
		...
		btnAgregar.setIcon(new ImageIcon(ComboVista.class
		...
		btnInformacion.setIcon(new ImageIcon(ComboVista.class
		...
		// ImageIcon(ComboVista.class.getResource("/Iconos/Quitar.png")));
		// btnEliminar.setFont(new Font("Tahoma", Font.BOLD, 11));
		// btnEliminar.setBounds(375, 138, 140, 40);
		// contentPane.add(btnEliminar);

		btnAceptar = new JButton(" Volver");
		btnAceptar.setIcon(new ImageIcon(ComboVista.class
		...
		lblNewLabel.setIcon(new ImageIcon(ComboVista.class
