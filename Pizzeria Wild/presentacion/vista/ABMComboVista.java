...
public class ABMComboVista extends JDialog {
	...
	public ABMComboVista(ComboVista Vista) {
		...
		btnEdit = new JButton("");
		btnEdit.setIcon(new ImageIcon(ABMComboVista.class
		...
		btnAgregar.setIcon(new ImageIcon(ABMComboVista.class
		...
		btnModificar.setIcon(new ImageIcon(ABMComboVista.class
				.getResource("/Iconos/modificar.png")));
		...
		btnEliminar.setIcon(new ImageIcon(ABMComboVista.class
		...
		btnVolver.setIcon(new ImageIcon(ABMComboVista.class
		...
		btnGuardar.setIcon(new ImageIcon(ABMComboVista.class
		...
		btnCancelar.setIcon(new ImageIcon(ABMComboVista.class
		...
		lblNewLabel.setIcon(new ImageIcon(ABMComboVista.class
