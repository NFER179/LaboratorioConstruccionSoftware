...
public class SolicitudCompraVista extends JFrame {
	...
	public SolicitudCompraVista() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				SolicitudCompraVista.class.getResource("/Iconos/pizza_1.PNG")));
		setResizable(false);
		setTitle(" Solicitud");
		...
		btnNuevaSolicitud.setIcon(new ImageIcon(SolicitudCompraVista.class
		...
		btnModificar.setIcon(new ImageIcon(SolicitudCompraVista.class
		...
		btnInformacion.setIcon(new ImageIcon(SolicitudCompraVista.class
				.getResource("/Iconos/info.png")));
		...
		btnSolicitudeEntregada.setIcon(new ImageIcon(SolicitudCompraVista.class
				.getResource("/Iconos/Entrega.png")));
		...
		btnVolver.setIcon(new ImageIcon(SolicitudCompraVista.class
