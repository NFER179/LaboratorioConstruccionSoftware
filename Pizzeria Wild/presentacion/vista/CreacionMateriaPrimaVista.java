...
public class CreacionMateriaPrimaVista extends JFrame {
	...
	public CreacionMateriaPrimaVista(CategoriaDetalleVista CDV) {
		...
		btnCrear.setIcon(new ImageIcon(CreacionMateriaPrimaVista.class
		...
		btnCancelar.setIcon(new ImageIcon(CreacionMateriaPrimaVista.class
		...
		lblNewLabel.setIcon(new ImageIcon(CreacionMateriaPrimaVista.class
		...
		//
		// this.modelCbxCategoria = new
		// DefaultComboBoxModel(this.valoresCbxCategoria);
		//
