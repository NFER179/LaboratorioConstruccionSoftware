...
public class RepartidorVista extends JFrame {
	...
	public RepartidorVista() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(RepartidorVista.class.getResource("/Iconos/pizza_1.PNG")));
		setResizable(false);
		...
		btnAgregar.setIcon(new ImageIcon(RepartidorVista.class.getResource("/Iconos/Agregar.png")));
		btnAgregar.setFont(new Font("Tahoma", Font.BOLD, 11));
		btnAgregar.setBounds(346, 37, 140, 40);
		contentPane.add(btnAgregar);
		
		btnModificar = new JButton(" Modificar");
		btnModificar.setIcon(new ImageIcon(RepartidorVista.class.getResource("/Iconos/modificar.png")));
		...
		btnVolver.setIcon(new ImageIcon(RepartidorVista.class.getResource("/Iconos/Volver.png")));
