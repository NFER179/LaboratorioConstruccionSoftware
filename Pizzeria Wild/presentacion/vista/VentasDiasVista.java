...
public class VentasDiasVista extends JDialog {
	...
	private String[] nombreColumnasVentas = { "Fecha Venta", "Numero Venta",
			"Cliente", "Facturado" };
	...
	private String[] nombreColumnasSolicitudes = { "Fecha Solicitud",
			"Numero Solicitud", "Proveedor", "Cobrado" };
	...
	public VentasDiasVista(ReporteVista Vista) {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(
				VentasDiasVista.class.getResource("/Iconos/pizza_1.PNG")));
		...
		JLabel lblCantidadVentasFacturadas = new JLabel(
				"Cantidad Ventas Facturadas:");
		...
		this.modelFacturadas = new WDefaultTableModel(null,
		...
		JLabel lblCantidadVentasCanceladas = new JLabel(
		...
		this.modelCanceladas = new WDefaultTableModel(null,
				this.nombreColumnasSolicitudes);
		...
		btnVolver.setIcon(new ImageIcon(VentasDiasVista.class
